...
const requiredProofs = [
  ...
  },
  {
    ...
    goal: 'G619',
    path: 'output/playwright/g752-g619-beta-evidence-post-g750-current-r1/current-summary.json',
  ...
  {
    id: 'g668_current_production_mass_market_qa',
    goal: 'G668',
