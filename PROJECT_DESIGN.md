...
2. Heavy Chain advantage: OpenAI-backed image generation, Jobs recovery, Gallery/History persistence, Canvas finishing, and material metadata safety.
...
- Preserve: OpenAI provider routing, Supabase redaction rules, auth/RLS safety, marker-scoped cleanup discipline.
