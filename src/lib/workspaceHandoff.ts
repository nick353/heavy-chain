    ...
    canvasStore.addObject({
      ...
      metadata: {
        ...
        parameters: {
          ...
          cutoutOutputSize: extractedMaterialReference.cutoutOutputSize,
          cutoutDataUrlBytes: extractedMaterialReference.cutoutDataUrlBytes,
          cutoutMaxDataUrlBytes: extractedMaterialReference.cutoutMaxDataUrlBytes,
          cutoutStoragePolicy: extractedMaterialReference.cutoutStoragePolicy,
