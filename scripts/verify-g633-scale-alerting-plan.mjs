...
for (const file of [
  ...
  // G631 is the current production broad-UX baseline named by the plan.
  // Keep this as a presence gate; validity still belongs to the G831/readback
  // verifier and must not be inferred from this planning check alone.
  'output/playwright/g831-prod-mass-market-current-r1/SUMMARY.json',
