...
const labExperimentCandidates: LabExperimentCandidate[] = [
  ...
  },
  {
    ...
    promptDraft: 'Lightchain retail display, sheer jacket, neutral gray studio shelf, crisp edge light',
  ...
  },
  {
    ...
    promptDraft: 'Lightchain campaign image, close crop, product texture, vertical social layout',
...
export function LabPage() {
  ...
  const handoffToCanvas = () => {
    ...
    toast.success('LabをGallery/Historyに保存し、Canvasへ渡しました');
