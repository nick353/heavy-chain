  ...
  return (
    <section className={`glass-panel rounded-2xl p-5 ${className}`}>
      ...
      <div className="mt-5 grid gap-3 sm:grid-cols-2 lg:grid-cols-1">
        <Link to="/designProduction" className="group flex items-center gap-3 rounded-xl bg-white/55 p-3 transition hover:bg-white dark:bg-surface-900/40 dark:hover:bg-surface-900/70">
