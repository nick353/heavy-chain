export type LightchainCategoryId = 'recommended' | 'planning' | 'fitting' | 'graphics' | 'editing' | 'cases';
...
export const lightchainCategories: LightchainCategory[] = [
  ...
  },
  {
    ...
    label: '画像編集',
    eyebrow: 'Edit',
    description: '背景削除、高解像度化、バリエーション、部分修正、切り抜きなどの周辺編集を既存生成機能と Canvas へ集約します。',
  },
  {
    id: 'cases',
    label: '事例共有',
    eyebrow: 'Cases',
    description: 'Lightchain の事例一覧に近い業務別テンプレートを、再開可能なワークフローとして開きます。',
  },
];
