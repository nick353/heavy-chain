-- Allow Runway MCP generation while Heavy Chain billing is not active.
-- Keep brand/user existence, Free-plan usage reservation, quota, rate limit,
-- idempotency, and observability guards intact.
