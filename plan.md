...
14. [pending] 最新の Lightchain clone UI を production へ反映し、Zeabur で同じ verifier/readback を取り直す。
...
- 未完了は production 反映と Zeabur 上の最新 clone verifier/readback。ここが通るまでは「localでLightchain構成に揃った」と言い、production完了とは呼ばない。
