...
- G619 gate: `docs/g619-real-beta-evidence-packet-2026-06-30.md` and `scripts/verify-g619-beta-evidence.mjs` define the consent-safe real-beta acceptance contract. `npm run verify:g619-beta-evidence -- --init-template` creates a template but records `ok=false`; normal verification currently fails because real beta evidence is not collected. A temporary positive fixture passed, and a sensitive-text fixture failed. G619 remains queued until real consented sessions pass this verifier.
