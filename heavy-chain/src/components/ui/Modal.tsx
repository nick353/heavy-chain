        ...
        <div className="fixed inset-0 z-[100] overflow-y-auto">
          ...
          <div className="min-h-full flex items-center justify-center p-2 sm:p-4 md:p-6">
            ...
            >
              ...
              {footer && (
                <div className="px-4 py-3 sm:px-6 sm:py-4 md:px-8 md:py-6 border-t border-neutral-100/50 dark:border-white/10 flex-shrink-0 bg-white/90 dark:bg-surface-900/90">
                  {footer}
                </div>
              )}
